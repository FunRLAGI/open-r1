...
```shell
docker build -t open-r1-containter .
docker run -it  --restart unless-stopped  --shm-size  32g --gpus all --privileged --name open-r1-docker -v /home/chentianqi/:/home/chentianqi/  open-r1-containter
```
